...
"""K1 Rev.1 Dance 1 Mimic environment configuration."""
...
TRAJECTORY_FILE = (
  SRC_PATH / "assets" / "motions" / "K1_rev1" / "dance1" / "dance1.npz"
)


def k1_rev1_dance1_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create the K1 Rev.1 Dance 1 Mimic configuration."""
