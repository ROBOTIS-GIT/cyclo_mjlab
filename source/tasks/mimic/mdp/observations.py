...
def reference_anchor_position_b(
...
def reference_anchor_orientation_b(
  env: ManagerBasedRlEnv, command_name: str
) -> torch.Tensor:
  command = cast(ReferenceTrajectoryCommand, env.command_manager.get_term(command_name))
...
def measured_body_positions_in_anchor_frame(
  env: ManagerBasedRlEnv, command_name: str
) -> torch.Tensor:
  command = cast(ReferenceTrajectoryCommand, env.command_manager.get_term(command_name))
...
def measured_body_orientations_in_anchor_frame(
  env: ManagerBasedRlEnv, command_name: str
) -> torch.Tensor:
  command = cast(ReferenceTrajectoryCommand, env.command_manager.get_term(command_name))
