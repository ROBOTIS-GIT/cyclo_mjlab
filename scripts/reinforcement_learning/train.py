...
from source.utils import export_sim2real_cfg
...
def run_train(task_id: str, cfg: TrainConfig, log_dir: Path) -> None:
  ...
  is_tracking_task = "reference_trajectory" in cfg.env.commands and isinstance(
    cfg.env.commands["reference_trajectory"], ReferenceTrajectoryCommandCfg
  )

  if is_tracking_task:
    motion_cmd = cfg.env.commands["reference_trajectory"]
